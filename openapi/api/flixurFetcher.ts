...
export type FlixurFetcherOptions<TBody, THeaders, TQueryParams, TPathParams> = {
  url: string;
  method: string;
  body?: TBody;
  headers?: THeaders;
  ...
  signal?: AbortSignal;
} & FlixurFetcherExtraProps;

export async function flixurFetch<
  TData,
  TError,
