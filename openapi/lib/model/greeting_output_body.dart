...
class GreetingOutputBody {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GreetingOutputBody &&
  ...
  @override
  String toString() => 'GreetingOutputBody[dollarSchema=$dollarSchema, message=$message]';
  ...
  static GreetingOutputBody? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'message'), 'Required key "GreetingOutputBody[message]" is missing from JSON.');
        assert(json[r'message'] != null, 'Required key "GreetingOutputBody[message]" has a null value in JSON.');
        return true;
      }());
  ...
  static List<GreetingOutputBody> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<GreetingOutputBody>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GreetingOutputBody>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GreetingOutputBody.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
